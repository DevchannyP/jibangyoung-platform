...
/**
 * A catalog of dependencies accessible via the {@code myLibs} extension.
 */
@NonNullApi
public class LibrariesForMyLibs extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForMyLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
